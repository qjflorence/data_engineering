Azure ETL project that uses Azure Data Factory to create a data pipeline to extract CSV files from my GitHub repository and stored in Azure Data Lake Gen 2.
